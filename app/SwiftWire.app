...
loop,%current_user_files%\*.*,2, 0
{
	...
	if (!ignorepath(category_path)){
		Gui, 1: Add, Text, x+20 y3 g%_category_sub%,%category%
		n := 0
...
; display the UI
Gui, 1: Show, x-20 y0 w%shadow_bar_width% h%tool_bar_height%, SwiftWire
...
;About SwiftWire
about_swiftwire:
MsgBox, 64, SwiftWire by Fluent, Version:  1.3.1.0`n`nCopyright © 2017`nFluent Systems`, Inc.`nPatent Pending`n`nDesktop Automation Reimagined

return

;show "user" menu
USERMENU_SHOW:
menu,USERMENU,show,0,26
return
