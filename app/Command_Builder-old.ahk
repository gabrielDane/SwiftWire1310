/*
    ...
    Copyright 2016, Fluent Systems, Inc. 
	
	Command Builder Rebuild
	This is due to an annoying bug during file rename
	Martin's Edit for Gabe
*/
...
Menu, Tray, Icon, %A_ScriptDir%\resources\images\forklift.ico ;CHANGES TRAY ICON
...
Gui, _guiCMDBuilder: -DPIScale
Gui, _guiCMDBuilder: Add, Picture, x0 y0 v_cmd_builder_black_ribbon g_cmd_builder_black_ribbon,%A_ScriptDir%\resources\images\CommandBuilderLogo2.bmp

Gui, _guiCMDBuilder: Font, S8 Bold CDefault, Verdana
Gui, _guiCMDBuilder: Add, Button, x12 y50 w130 h30 v_cmd_builder_new_category g_cmd_builder_new_category, ➕ Category
Gui, _guiCMDBuilder: Add, Button, x142 y50 w130 h30 v_cmd_builder_new_command g_cmd_builder_new_command, ➕ Automation

Gui, _guiCMDBuilder: Font, S10 Bold CDefault, Verdana
Gui, _guiCMDBuilder: Add, Text, x288 y54 h20 , Automation Steps

Gui, _guiCMDBuilder: Font, S8 Bold CDefault, Verdana
;Gui, _guiCMDBuilder: Add, Button, x520 y50 w100 h30 v_cmd_builder_share g_cmd_builder_share, Share
;Gui, _guiCMDBuilder: Add, Button, x520 y50 w100 h30 gsharecommand, Share

Gui, _guiCMDBuilder: Font, S10 Bold CDefault, Verdana
Gui, _guiCMDBuilder: Add, Text, x640 y54 h20 , Build Assistants

;Tree View
Gui, _guiCMDBuilder: Font, S8 Normal CDefault, Verdana
Gui, _guiCMDBuilder: Add, TreeView, x12 y90 w260 h390 v_cmd_builder_treeview g_cmd_builder_treeview +AltSubmit imageList%TVImageList%,

;Command Edit Area
Gui, _guiCMDBuilder: Font, S8 Bold CDefault, Verdana
Gui, _guiCMDBuilder: Add, Edit, C272822 x283 y90 w340 h390 v_cmd_builder_edit g_cmd_builder_edit hwnd_cmd_builder_edit_hwnd WantTab Disabled,

Gui, _guiCMDBuilder: Font, S8 Bold CDefault, Verdana
Gui, _guiCMDBuilder: Add, Button, x342 y490 w100 h30 v_cmd_builder_save g_cmd_builder_save Disabled, Save
Gui, _guiCMDBuilder: Add, Button, x452 y490 w100 h30 v_cmd_builder_cancel g_cmd_builder_cancel Disabled, Cancel

;Quick Tools
Gui, _guiCMDBuilder: Font, S8 Normal CDefault, Verdana
Gui, _guiCMDBuilder: Add, Text, x640 y88, To type text on the screen:
Gui, _guiCMDBuilder: Add, Button, y+5 v_cmd_builder_quicktools_sendtext g_cmd_builder_quicktools_sendtext, Send`, Text

Gui, _guiCMDBuilder: Add, Text, , To press Enter:
Gui, _guiCMDBuilder: Add, Button, y+5 v_cmd_builder_quicktools_sendenter g_cmd_builder_quicktools_sendenter, Send`, {Enter}
Gui, _guiCMDBuilder: Add, Text, , To wait 1-Second:
Gui, _guiCMDBuilder: Add, Button, y+5 v_cmd_builder_quicktools_sendsleep1000 g_cmd_builder_quicktools_sendsleep1000, Sleep`, 1000
Gui, _guiCMDBuilder: Add, Text, , Click the mouse at X640`, Y480:
Gui, _guiCMDBuilder: Add, Button, y+5 v_cmd_builder_quicktools_click640_480 g_cmd_builder_quicktools_click640_480, Click`, 640`, 480

;Shortcuts
Gui, _guiCMDBuilder: Font, S8 Bold CDefault, Verdana
;Gui, _guiCMDBuilder: Add, Text, y+15 , Shortcuts:
Gui, _guiCMDBuilder: Add, Text, y+30 , Keypress Shortcuts
Gui, _guiCMDBuilder: Font, S8 Normal CDefault, Verdana

Gui, _guiCMDBuilder: Add, Button, y+15 v_cmd_builder_quicktools_ctrlkey g_cmd_builder_quicktools_ctrlkey, Ctrl Key (^)
Gui, _guiCMDBuilder: Add, Button, x+5 v_cmd_builder_quicktools_shiftkey g_cmd_builder_quicktools_shiftkey, Shift (+)
Gui, _guiCMDBuilder: Add, Button, x+5 v_cmd_builder_quicktools_altkey g_cmd_builder_quicktools_altkey, Alt (!)

;Gui, _guiCMDBuilder: Add, Button, x640 y+10 v_cmd_builder_quicktools_sleep0_5_sec g_cmd_builder_quicktools_sleep0_5_sec, Sleep 0.5 sec
;Gui, _guiCMDBuilder: Add, Button, x+5 v_cmd_builder_quicktools_sleep1_0_sec g_cmd_builder_quicktools_sleep1_0_sec, 1.0 sec
;Gui, _guiCMDBuilder: Add, Button, x+5 v_cmd_builder_quicktools_sleep2_0_sec g_cmd_builder_quicktools_sleep2_0_sec, 2.0 sec

;Gui, _guiCMDBuilder: Add, Button, x640 y+10 v_cmd_builder_quicktools_progressnotes g_cmd_builder_quicktools_progressnotes, Open Progress Notes
;Gui, _guiCMDBuilder: Add, Button, x640 y+10 v_cmd_builder_quicktools_orderentry g_cmd_builder_quicktools_orderentry, Order Entry
;Gui, _guiCMDBuilder: Add, Button, x+5 v_cmd_builder_quicktools_LOS g_cmd_builder_quicktools_LOS, LOS
;Gui, _guiCMDBuilder: Add, Button, x+5 v_cmd_builder_quicktools_Diagnosis g_cmd_builder_quicktools_Diagnosis, Diagnosis
Gui, _guiCMDBuilder: Show, w888 h536, %window_name%
...
InputBox,newname,Rename %type%,Type the new name,,200,125
if errorlevel
	return
...
InputBox, command, New Automation,Name the new automation,,200,125
if errorlevel
	return
